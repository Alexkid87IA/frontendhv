...
const testimonialVideos = [
  ...
  {
    id: 4,
    thumbnail: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80",
  ...
  {
    id: 5,
    thumbnail: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80",
...
export const CoachingTestimonialsSection = () => {
