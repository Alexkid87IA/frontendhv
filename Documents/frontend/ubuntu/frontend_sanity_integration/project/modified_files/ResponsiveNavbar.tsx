...
export const ResponsiveNavbar = () => {
  ...
  const menuItems = [
    ...
    { label: 'Mental', path: '/rubrique/mental', icon: Brain, slug: 'mental' }, // Modifié pour correspondre au slug Sanity
    { label: 'Society', path: '/rubrique/society', icon: Users, slug: 'society' }, // Modifié pour correspondre au slug Sanity
    { label: 'Émissions', path: '/emissions', icon: Film, slug: 'emissions' } // Slug ajouté pour la cohérence, même si non utilisé pour une page catégorie
  ];
