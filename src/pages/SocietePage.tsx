...
export const SocietePage = () => {
  return (
    <>
      <SEO
        title="Société | Décryptage des mutations contemporaines"
        ...
        image="https://26.staticbtf.eno.do/v1/29-default/56769c87961b44f9f4db440f67dc4c72/media.jpg"
      />
      <div className="pb-20">
        {/* Hero Section */}
        ...
        <section className="container py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {societeDomains.map((domain, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
