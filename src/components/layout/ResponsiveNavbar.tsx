          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <Link
                ...
                className="relative inline-flex items-center justify-center overflow-hidden rounded-md px-5 py-2.5 text-sm font-medium transition-all duration-300"
              >
                {/* Animated gradient background - Using a darker blue */}
                <span className="absolute inset-0 rounded-md bg-gradient-to-r from-blue-700 to-blue-500 opacity-100"></span>
                
                {/* Animated glow effect - Using a darker blue */}
                <span className="absolute inset-0 rounded-md bg-gradient-to-r from-blue-700 to-blue-500 blur-[2px] opacity-50 animate-pulse"></span>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="px-4 space-y-4 pt-4 border-t border-white/10">
              ...
              <div className="relative overflow-hidden rounded-lg group">
                {/* Animated gradient background - Using a darker blue */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-700 to-blue-500 rounded-lg opacity-80 group-hover:opacity-100 blur-sm transition-all duration-300 animate-pulse"></div>
                ...
                >
                  {/* Subtle animated background */}
                  <span className="absolute inset-0 bg-gradient-to-r from-blue-700/20 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
