...
export const HeroSection = () => {
  const [mainArticle, setMainArticle] = React.useState<SanityArticle | null>(null);
  const [latestArticles, setLatestArticles] = React.useState<SanityArticle[]>([]);
  const [quoteOfTheDay, setQuoteOfTheDay] = React.useState<Quote | null>(null);
            ...
            <div className="lg:col-span-7 xl:col-span-8">
              <article className="bg-hv-card-bg rounded-xl shadow-lg overflow-hidden border border-hv-card-border h-full">
                <div className="relative h-64 md:h-80 overflow-hidden">
                  <SafeImage 
                    image={mainArticle.mainImage}
                    alt={mainArticle.title || "Article principal"}
                    width={800}
                    height={450}
